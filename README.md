...
- [Multi-Asset Trading Algorithm](#multi-asset-trading-algorithm)
  ...
  - [7. Návod k použití / Režimy](#7-návod-k-použití--režimy)
    - [Požadavky](#požadavky)
    - [Režim 1 – Plný backtest (výchozí)](#režim-1--plný-backtest-výchozí)
    - [Režim 2 – Rychlá analýza jednoho assetu](#režim-2--rychlá-analýza-jednoho-assetu)
    - [Režim 3 – Hodinová analýza všech assetů](#režim-3--hodinová-analýza-všech-assetů)
    - [Jak vybrat nejlepší asset k nákupu](#jak-vybrat-nejlepší-asset-k-nákupu)
    - [Jak změnit časové období backtestу](#jak-změnit-časové-období-backtestу)
